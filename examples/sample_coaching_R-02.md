...
Across every pitch this run, the problem and the category never landed together — that pair is what separates the new message from the old pitch.

*What to improve*
Say the problem out loud before you move into the product. Done looks like: it appears in the first two minutes of the call.
